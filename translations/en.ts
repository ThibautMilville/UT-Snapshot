...
const en: Record<TranslationKey, string> = {
  ...
  'landing.hero.title.part1': 'Automate your',
  'landing.hero.title.part2': 'Snapshots & Airdrops',
  'landing.hero.title.part3': 'on Ultra',
  'landing.hero.subtitle': 'Save time, engage your community, and manage your token holders effortlessly with our advanced automation platform.',
